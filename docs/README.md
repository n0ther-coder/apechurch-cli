...
|------|----------|------------|-------|-------|
| `docs/COMMAND_REFERENCE.md` | Users / maintainers | High | Yes | Canonical CLI command surface, including top-level commands, supported aliases, options, and shared BNF. |
...
| `docs/BOT_PLUGINS.md` | Maintainers / private-bot authors | Medium | Yes | Naming, directory, play-only boundary, and security note for private bot-plugin work. |
...
| `docs/analytics/README.md` | Users / maintainers | High | Yes | Index of exact analytics notes for games with compact, fully documentable outcome surfaces. |
| `docs/analytics/*.md` | Users / maintainers | High | Yes | Exact analytics distributions intended to support game-selection decisions. |
