...
--recover-loss <ape>      # Stop once net P&L reaches -<ape>, then gets back to break-even/profit
--giveback-profit <ape>   # Stop once net P&L reaches +<ape>, then falls back to break-even/loss
