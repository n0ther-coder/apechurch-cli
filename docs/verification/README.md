...
| Blocks | `BLOCKS_CONTRACT.md` | Current and legacy addresses, selectable-grid tuple, independent/compounding modes, grid-scaled VRF gas, and all payout tables |
| Primes | `PRIMES_CONTRACT.md` | Difficulty table, prime-or-zero payout model, and exact RTP by mode |
| Blackjack | `BLACKJACK_CONTRACT.md` | Public ABI trail, action costs, state layout, H17 evidence, and solver-rule alignment |
