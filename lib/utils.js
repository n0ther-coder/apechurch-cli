...
/**
 * Validate an Ethereum address and return it, or ZERO_ADDRESS if invalid
 *
 * Used for referral addresses - we accept any valid address but fall back
 * to zero address (no referral) for invalid/missing inputs.
 *
 * @param {string|null|undefined} address - Address to validate
 * @returns {string} Valid checksummed address or ZERO_ADDRESS
 *
 * @example
 * getValidRefAddress('0x1234...') // Returns '0x1234...'
 * getValidRefAddress(null)        // Returns ZERO_ADDRESS
 * getValidRefAddress('invalid')   // Returns ZERO_ADDRESS
 */
 ...
 *
 * @example
 * ensureDir('/home/user/.apechurch/skill')
 * // Creates ~/.apechurch and ~/.apechurch/skill if they don't exist
 */
