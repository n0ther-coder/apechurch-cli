 ...
 * 
 * Difficulty modes:
 *   0 (Easy): Lose on 7 only
 *   1 (Normal): Slightly harder
 *   2 (Hard): Lose on 6,7,8
 *   3 (Extreme): Very hard
 *   4 (Master): Almost impossible
 * 
 * WARNING: Modes 2-4 are extremely risky. Stick to 0-1 for auto-play.
 */
...
export function getBearDiceConfig(opts, positionalConfig, strategyConfig, randomIntInclusive) {
  ...
  if (opts.difficulty !== undefined) {
    ...
    // For auto-play, stick to easy modes (0-1)
