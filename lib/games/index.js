...
const gameHandlers = {
  ...
  blocks: playBlocks,       // Blocks (3x3 max-of-a-kind board, consecutive all-or-nothing rolls)
 ...
 * @param {number} [params.split] - Number of independent split attempts for Plinko, Speed Keno, Primes, or slots
