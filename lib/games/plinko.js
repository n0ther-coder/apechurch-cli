...
import { getPlinkoVrfFee, getStaticVrfFee, executeGame, randomBytes32, randomUint256, getValidRefAddress } from './base.js';
...
export function getPlinkoConfig(opts, positionalConfig, gameEntry, strategyConfig, randomIntInclusive) {
  const config = {};
  const strategyMode = Array.isArray(strategyConfig.plinko?.mode)
    ? strategyConfig.plinko.mode
