 ...
 * - This represents their win probability as a percentage
 * - The VRF generates a random number 1-100
 * - Player wins if the random number is ≤ their chosen range
 *
 * Payout calculation:
 * - Lower range = higher payout (inverse relationship)
 * - Payout ≈ 97.5 / range (2.5% house edge)
 *
 * Examples:
...
export async function playApestrong({
  ...
  // Calculate approximate payout for display
  // Formula: payout ≈ 97.5 / range (2.5% house edge)
