...
export const BOTS_DIR_BASENAME = 'bots';
export const LOG_DIR_BASENAME = 'log';
export const R2_DIR_BASENAME = 'r2';
export const SCR_DIR_BASENAME = 'scripts';
...
export const CONFIG_DIR_ENV_VAR = 'APECHURCH_CLI_CONFIG_DIR';
export const BOTS_DIR_ENV_VAR = 'APECHURCH_CLI_BOTS_DIR';
export const LOG_DIR_ENV_VAR = 'APECHURCH_CLI_LOG_DIR';
export const SCR_DIR_ENV_VAR = 'APECHURCH_CLI_SCR_DIR';
export const R2_ACCOUNT_ID_ENV_VAR = 'APECHURCH_CLI_R2_ACCOUNT_ID';
export const R2_NAME_ENV_VAR = 'APECHURCH_CLI_R2_NAME';
export const R2_TOKEN_ENV_VAR = 'APECHURCH_CLI_R2_TOKEN';
export const R2_KEY_ENV_VAR = 'APECHURCH_CLI_R2_KEY';
export const R2_SECRET_ENV_VAR = 'APECHURCH_CLI_R2_SECRET';
export const R2_PREFIX_ENV_VAR = 'APECHURCH_CLI_R2_PREFIX';
export const RPC_URL_ENV_VAR = 'APECHAIN_RPC_URL';
export const SUPPRESS_VERSION_BANNER_ENV_VAR = 'APECHURCH_CLI_SUPPRESS_VERSION_BANNER';
export const FORCE_CHIME_ENV_VAR = 'APECHURCH_CLI_FORCE_CHIME';
export const SUPPRESS_CHIME_ENV_VAR = 'APECHURCH_CLI_SUPPRESS_CHIME';
export const NO_COLOR_ENV_VAR = 'NO_COLOR';
export const FORCE_COLOR_ENV_VAR = 'APECHURCH_CLI_FORCE_COLOR';
export const BOT_PLAIN_OUTPUT_ENV_VAR = 'APECHURCH_CLI_BOT_PLAIN_OUTPUT';
...
function resolvePathEnv(envVar, fallback) {
 ...
 * Default: ~/.apechurch-cli/
 * @type {string}
 */
export const APECHURCH_DIR = resolvePathEnv(
  CONFIG_DIR_ENV_VAR,
  path.join(HOME, DATA_DIR_BASENAME),
);
...
/**
 * Directory for selectable encrypted wallets.
 * Each selectable wallet lives at wallets/<address>.json. The current wallet
 * selector lives at wallets/current.json and contains no private key material.
 * @type {string}
 */
export const WALLETS_DIR = path.join(APECHURCH_DIR, 'wallets');

/**
 * Current wallet selector file - contains only public pointer metadata.
 * CRITICAL: This file must never contain a plaintext private key.
 * @type {string}
 */
export const WALLET_FILE = path.join(WALLETS_DIR, 'current.json');

/**
 * Directory for per-wallet session state
 * @type {string}
 */
export const STATES_DIR = path.join(APECHURCH_DIR, 'states');

/**
 * Directory for per-wallet profiles
 * @type {string}
 */
export const PROFILES_DIR = path.join(APECHURCH_DIR, 'profiles');

/**
 * Per-wallet history directory
 * Contains files like ~/.apechurch-cli/history/<wallet>_history.json
 * @type {string}
 */
...
/**
 * Directory for per-wallet active game queues
 * @type {string}
 */
export const ACTIVE_GAMES_DIR = path.join(APECHURCH_DIR, 'games');

/**
 * Directory for per-wallet scoreboards derived from saved history
 * Contains files like ~/.apechurch-cli/scores/<wallet>_score.json
 * @type {string}
 */
export const SCORES_DIR = path.join(APECHURCH_DIR, 'scores');
export const R2_DIR = path.join(APECHURCH_DIR, R2_DIR_BASENAME);
export const BOTS_DIR = resolvePathEnv(
  BOTS_DIR_ENV_VAR,
  path.join(APECHURCH_DIR, BOTS_DIR_BASENAME),
);
export const LOG_DIR = resolvePathEnv(
  LOG_DIR_ENV_VAR,
  path.join(APECHURCH_DIR, LOG_DIR_BASENAME),
);
export const SCR_DIR = resolvePathEnv(
  SCR_DIR_ENV_VAR,
  path.join(APECHURCH_DIR, SCR_DIR_BASENAME),
);
...
/**
 * Base GP (Gimbo Points) earned per APE wagered on standard weeks.
...
export const LEGACY_GP_TOKEN_CONTRACT = '0x0382338f3876237aE89317A6a8207C432d430B93';
export const GP_REWARD_TOKEN_CONTRACTS = Object.freeze([
  GP_TOKEN_CONTRACT,
...
export const BLOCKS_CONTRACT = '0x74D430c8e705eBB8EF0BA05bfDe54E901410a288';
export const LEGACY_BLOCKS_CONTRACT = '0xA59CF828222EcD8aCe4b6195764d11F5Ea7f62A6';
...
export const GEEZ_DIGGERZ_CONTRACT = '0xB02b13Adb8eAaFe1F41ec942612C4a4862b74d1D';
export const GIMBOZ_SMASH_CONTRACT = '0x17e219844F25F3FED6E422DdaFfD2E6557eBCEd3';
export const GLYDE_OR_CRASH_CONTRACT = '0x5b44ce34300d1b8d32b5a6119f192e3eda74e144';
export const SUSHI_SHOWDOWN_CONTRACT = '0x7B53Ec7A5e1C30D4b91D2c3Ec0472a6E4818a657';
export const REEL_PIRATES_CONTRACT = '0x5E405198B349d6522BbB614E7391bDC4F4F6f681';
...
export const HI_LO_NEBULA_CONTRACT = '0xa67d5CD51028cAaa367eEFcE90a5eA0b71c6cBE2';
export const CASH_DASH_CONTRACT = '0xbcfA645D79F4ccF2B5448aC67309DCd15Bc94035';
export const BLIZZARD_BLITZ_CONTRACT = '0x64b27c1c69559A795C98958614398dD7195AE1B8';
export const GIMBOZ_GALAXY_CONTRACT = '0x1AC78E6a153DeEd1b8dB67b9813991651D53E3a6';
export const RICOS_REVENGE_CONTRACT = '0xC1046a6B4c01512803772b25f72d9f6FF27F94a7';
export const CULT_QUEST_CONTRACT = '0xaF107530b56F86eCD59F03A93fb5044F32E02ae9';
...
export const GAME_CONTRACT_ADDRESSES = Object.freeze({
  ...
  blocks: BLOCKS_CONTRACT,
  'dino-dough': DINO_DOUGH_CONTRACT,
  'bubblegum-heist': BUBBLEGUM_HEIST_CONTRACT,
  'geez-diggerz': GEEZ_DIGGERZ_CONTRACT,
  'gimboz-smash': GIMBOZ_SMASH_CONTRACT,
  'glyde-or-crash': GLYDE_OR_CRASH_CONTRACT,
  'sushi-showdown': SUSHI_SHOWDOWN_CONTRACT,
  'reel-pirates': REEL_PIRATES_CONTRACT,
  ...
  'hi-lo-nebula': HI_LO_NEBULA_CONTRACT,
  'cash-dash': CASH_DASH_CONTRACT,
});

export const HISTORY_ONLY_GAME_CONTRACT_ADDRESSES = Object.freeze({
  'blizzard-blitz': BLIZZARD_BLITZ_CONTRACT,
  'gimboz-galaxy': GIMBOZ_GALAXY_CONTRACT,
  'ricos-revenge': RICOS_REVENGE_CONTRACT,
  'cult-quest': CULT_QUEST_CONTRACT,
});
