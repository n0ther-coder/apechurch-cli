...
export const PACKAGE_NAME = '@apechurch-hf/apechurch-cli-gx54';
export const BINARY_NAME = 'apechurch-cli-gx54';
export const SKILL_NAME = 'apechurch-cli-gx54';
export const DATA_DIR_BASENAME = '.apechurch-cli-gx54';
export const PASS_ENV_VAR = 'APECHURCH_CLI_GX54_PASS';
export const PROFILE_URL_ENV_VAR = 'APECHURCH_CLI_GX54_PROFILE_URL';
export const PRIVATE_KEY_ENV_VAR = 'APECHURCH_CLI_GX54_PK';
...
/**
 * Game history file - last N games played with outcomes
 ...
 * Can be overridden via APECHURCH_CLI_GX54_PROFILE_URL environment variable
 * @type {string}
 */
