...
function renderGameJson(state, actions, opts = {}) {
  ...
  const solverMaxStates = opts.solverMaxStates ?? getDefaultSolverMaxStates(opts.autoMode);
  const solverTimeoutMs = opts.solverTimeoutMs ?? getDefaultSolverTimeoutMs(opts.autoMode);
