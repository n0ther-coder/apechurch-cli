 ...
 *
 * @example
 * listStatefulGames() // ['blackjack', 'hi-lo-nebula', 'video-poker']
 */
...
/**
 * Resolve a game name to its registry entry
 *
 * @param {string|null} input - Game name
 * @returns {Object|null} Registry entry with added 'key' field, or null if not found
 *
 * @example
 * resolveStatefulGame('blackjack') // Returns blackjack entry
