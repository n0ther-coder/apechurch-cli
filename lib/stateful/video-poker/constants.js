...
// Fixed bet amounts (APE), verified from live getBetAmounts().
export const BET_AMOUNTS = Object.freeze([10, 25, 50, 100, 250, 400]);
export const MAX_BET_INDEX = 5; // 400 APE - jackpot eligible
...
// Contract ABI (verified against the live ApeChain source)
export const VIDEO_POKER_ABI = [
  ...
  {
    name: 'determinePayoutFromRawNumbers',
    type: 'function',
    stateMutability: 'pure',
    inputs: [
      { name: 'rawNumbers', type: 'uint8[]' },
      { name: 'betAmount', type: 'uint256' },
    ],
    outputs: [{ type: 'uint256' }, { type: 'uint8' }],
  },
