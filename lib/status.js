...
function resolveStatusSummaryIdentity({
  ...
  const displayGame = gameName || resolveHistoryGameName(contract);
  ...
  const finalVariantLabel = (useResolvedVideoPokerVariant ? resolvedVariant.variantLabel : null)
    || variantLabel
  ...
  return {
    ...
    rtpConfig: rtpConfig || resolvedVariant.rtpConfig || config || null,
  };
}
