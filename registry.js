  ...
  // ===========================================================================
  {
    ...
    config: {
      mode: {
        ...
        default: 0,
        cliName: 'risk',
        description: 'Risk level. 0=Low, 1=Moderate, 2=High, 3=Degen, 4=Ultra Degen.',
        bnf: [
          '<risk> ::= <integer> | "Low" | "Moderate" | "High" | "Degen" | "Ultra Degen"',
          '; semantic constraint: 0 <= value <= 4',
        ],
        options: [
          { value: 0, label: 'Low', aliases: ['safe'], desc: 'Tightest Jungle board, lowest variance and smallest tail' },
          { value: 1, label: 'Moderate', aliases: ['medium'], desc: 'Balanced Jungle board with wider swings than Low' },
          { value: 2, label: 'High', desc: 'Higher volatility and a much larger top-end payout' },
          { value: 3, label: 'Degen', aliases: ['extreme'], desc: 'Very spiky board built around big tail outcomes' },
          { value: 4, label: 'Ultra Degen', aliases: ['ultradegen'], desc: 'Maximum Jungle volatility and the highest moonshot buckets' },
        ],
      },
      balls: {
        min: 1,
  ...
  // ===========================================================================
  {
    ...
    config: {
      mode: {
        ...
        default: 0,
        cliName: 'risk',
        description: 'Risk level. 0=Low, 1=Modest, 2=High.',
        bnf: [
          '<risk> ::= <integer> | "Low" | "Modest" | "High"',
  ...
  // ===========================================================================
  {
    ...
    config: {
      mode: {
        ...
        cliMax: 1,
        cliDefault: 0,
        description: 'Risk level. 0=Low uses 6 monkey types; 1=High uses 7 monkey types and a more volatile payout surface.',
        bnf: [
          '<risk> ::= <integer> | "Low" | "High"',
          '; semantic constraint: value ∈ {0, 1}',
        ],
        options: [
          { value: 1, publicValue: 0, label: 'Low', aliases: ['low risk'], desc: '6 monkey types, easier matches, lower variance, 97.99% exact RTP' },
          { value: 2, publicValue: 1, label: 'High', aliases: ['high risk', 'normal risk'], desc: '7 monkey types, harder matches, higher exact RTP at 98.29%' },
        ],
      },
    },
    vrf: {
  ...
  // ===========================================================================
  {
    ...
    config: {
      difficulty: {
        ...
        default: 0,
        cliName: 'risk',
        description: 'Risk level. Higher = more losing sums. Stick to 0 for the safest default.',
        bnf: [
          '<risk> ::= <integer> | "Easy" | "Medium" | "Hard" | "Expert" | "Master"',
          '; semantic constraint: 0 <= value <= 4',
        ],
        options: [
          { value: 0, label: 'Easy', desc: 'Lose on 7 — safest mode' },
          { value: 1, label: 'Medium', aliases: ['normal'], desc: 'Lose on 6,7,8 — moderate risk' },
          { value: 2, label: 'Hard', desc: 'Lose on 5,6,7,8,9 — very risky!' },
          { value: 3, label: 'Expert', aliases: ['extreme'], desc: 'Lose on 4,5,6,7,8,9,10 — brutal' },
      ...
      rolls: {
        ...
        default: 1,
        cliName: 'survive',
        description: 'Number of all-or-nothing survival rolls (1-5). Higher survive count = higher payout, but the first losing sum zeroes the entire payout.',
        bnf: [
          '<survive> ::= <integer>',
          '; semantic constraint: 1 <= value <= 5',
        ],
  ...
  // ===========================================================================
  {
    ...
    config: {
      difficulty: {
        ...
        default: 0,
        cliName: 'risk',
        description: 'Risk level. Higher modes expand the number space, lower the hit rate, and raise the fixed zero payout.',
        bnf: [
          '<risk> ::= <integer> | "Easy" | "Medium" | "Hard" | "Extreme"',
...
const SUPPLEMENTAL_DISPLAY_GAMES = Object.freeze([
  ...
  Object.freeze({
    key: 'blizzard-blitz',
    name: 'Blizzard Blitz',
    aliases: ['blizzardblitz', 'blizzard'],
  ...
  Object.freeze({
    key: 'ricos-revenge',
    name: "Rico's Revenge",
    aliases: ['ricosrevenge', 'ricos', 'rico'],
